...
function hubRawSlotOptions_() {
  return [
    ...
    'VP', 'Weekly', 'Workflow (Slack)', 'FLC', 'Sensitives', 'Appeal Flow', 'Pangaea', 'Reversals', 'CSAT-HE', 'OBF', 'OBF MA/AB',
...
/** Regrava aba Controle de Slots a partir do dicionário estático (Config_Slots / SlotDictionaryStatic). */
